...
@Repository
public interface GermplasmProjectionResources extends JpaRepository<ValueEntity, Integer> {
    ...
    @Query(value = "select distinct on (v.value) value\n" +
            ...
            countQuery = "select count(distinct v.value)\n" +
                    ...
                    "where a.displayed_Name='Infraspecific name'",
            nativeQuery = true)
    Page<GermplasmProjection> getPagedGermplasmProjections(Pageable pageable);
    ...
    @Query(value = "select distinct on (v.value) value\n" +
            ...
            nativeQuery = true)
    Page<GermplasmProjection> getPagedStudiesGermplasmsByStudyDbId(@Param("studyDbId") Integer studyDbId, Pageable pageable);
}
