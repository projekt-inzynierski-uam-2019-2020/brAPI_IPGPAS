...
import org.brapi_igpas.brapi.service.study.StudyService;
...
public class StudyController {
    ...
    public BrApiDetailResponse getBrApiDetailResponse(
        ...
        return studyService.getStudiesBrApiDetailResponse(commonCropName, studyTypeDbId, programDbId, locationDbId, seasonDbId, trialDbId,
    ...
    public BrApiDetailResponse getBrApiDetailResponse(
            ...
            @RequestParam(value = "pageSize", defaultValue = "1000")
            @Min(value = 1, message = "'pageSize' value is invalid.") final int pageSize) {
        return studyService.getStudiesBrApiDetailResponse(studyDbId, page, pageSize);
    }
}
